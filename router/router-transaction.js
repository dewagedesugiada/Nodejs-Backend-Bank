...
module.exports = function(app){
    ...
    app.route('/transaction/:id').get(controller.transactionById);
    app.route('/transaction').post(controller.insertTransaction);
    app.route('/transaction').put(controller.updateTransaction);
    app.route('/transaction/:id').delete(controller.deleteTransaction);
    app.route('/transactionAcc/:id').get(controller.transactionByIdAcc);
